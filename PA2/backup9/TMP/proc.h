...
struct	pentry	{
	...
	long lwtime;
	int plstate[50];
	int lhold[50];     /*array to hold all locks for process*/
	int ret_del[50]; /*array to hold for deleted*/
	int pinh;		/*new priority variable*/
	int lblocked;	/*in which lock the process is blocked*/
};
